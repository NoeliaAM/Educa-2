...
<div class="row">
      <h3 align="center" class="header">Bienvenidos profesores</h3>
      <h6 align="center">Educa-2, un lugar donde interactuan todos.</h6>
      <h5 align="center"><i class="small material-icons prefix">supervisor_account</i> Registrate como profesor</h5>
</div>
<div class="container">
<div class="col s12">
    <div class="card horizontal green lighten-4">
      <div class="card-image"><img src="../images/mac.jpg"></div>
      <div class="card-stacked">
        <div class="card-content">
            <form action="registro_maestros.php" method="POST">
                  ...
                  <p class="center">¿Eres alumno? <a href="registrarse.php">Registrate aqui</a></p>
            </form>
        </div>
      </div>
    </div>
