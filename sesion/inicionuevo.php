...
<center><h3>Bienvenido a la familia Educa-2</h3></center>
<div class="container">
...
<div class="col s12 m12 l12">
            <div class="col s12 m4 l4">
              <div class="center promo promo-example">
                ...
                <a class="waves-effect waves-light btn red lighten-2" href="../temas/math_a1.php"  class="black-text"><i class="material-icons right">trending_flat</i>Ir</a>
              </div>
            </div>
            <div class="col s12 m4 l4">
              <div class="center promo promo-example">
                ...
                <a class="waves-effect waves-light btn red lighten-2" href="../temas/ingles.php"><i class="material-icons right">trending_flat</i>Ir</a>
              </div>
            </div>
            <div class="col s12 m4 l4">
              <div class="center promo promo-example">
                ...
                <p class="light center">Descarga archivos para complementar tu informacion, ¡tus profesores pueden compartir archivos contigo tambien!</p>
...
<div class="col s12 m12 l12">
            <div class="col s12 m4 l4">
              <div class="center promo promo-example">
                <a href="../temas/math_a1.php" class="black-text"><i class="large material-icons">done</i></a>
            ...
            <div class="col s12 m4 l4">
              <div class="center promo promo-example">
                <a href="../simuladores/simuladores.php" class="black-text" class="black-text"><i class="large material-icons">equalizer</i></a>
            ...
            <div class="col s12 m4 l4">
              <div class="center promo promo-example">
                ...
                <p class="light center">¿Necesitas ayuda? Consulta a nuestros asesores de una forma facil y rapida.</p>
              </div>
            </div>
</div>
</div>
